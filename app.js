...
additionButton.addEventListener('click', () => {
    const sum = Number(additionNumberOne.value) + Number(additionNumberTwo.value);
...
subtractionButton.addEventListener('click', () => {
    const sum = Number(subtractionNumberOne.value) + Number(subtractionNumberTwo.value);
...
multiplyButton.addEventListener('click', () => {
    const sum = Number(multiplyNumberOne.value) * Number(multiplyNumberTwo.value);
...
divisionButton.addEventListener('click', () => {
    const sum = Number(divideNumberOne.value) / Number(divideNumberTwo.value);
